  ...
  return (
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none bg-transparent text-white h-full rounded-none focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-20",
      ...
      <div className="absolute inset-0 flex items-center rounded-none pointer-events-none">
